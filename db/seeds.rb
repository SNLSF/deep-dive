...
books = [
	[{title: "The XX Factor"},
	 {date: "2013"},
	 {image: "https://i.imgur.com/f0jA4Lj.jpg"}],
	[{title: "Bad Feminist"},
	 {date: "2014"},
	 {image: "https://i.imgur.com/O5z6tNo.jpg"}],
	[{title: "The Feminist Porn Book"},
	 {date: "2013"},
	 {image: "https://i.imgur.com/0I0WzXO.jpg"}],
	[{title: "Feminism Unfinished"},
	 {date: "2015"},
	 {image: "https://i.imgur.com/iacNp7H.jpg"}],
	[{title: "Separate and Dominate"},
	 {date: "2015"},
	 {image: "https://i.imgur.com/XmnzErv.jpg"}], 
	[{title: "Talking Back"},
	 {date: "1988"},
	 {image: "https://i.imgur.com/ls4a0jo.jpg"}], 
	[{title: "Hard to Get"},
	 {date: "2013"},
	 {image: "https://i.imgur.com/heSpO0v.jpg"}], 
	[{title: "Lean In"},
	 {date: "2013"},
	 {image: "https://i.imgur.com/nqIrmix.jpg"}], 
	[{title: "Pussy Riot, A Punk Prayer for Freedom"},
	 {date: "2012"},
	 {image: "https://i.imgur.com/uf8Jr5o.jpg"}], 
	[{title: "A Class by Herself"},
	 {date: "2015"},
	 {image: "https://i.imgur.com/mkaIiWb.gif"}], 
	[{title: "Woman, An Intimate Geography"},
	 {date: "2014"},
	 {image: "https://i.imgur.com/23UsK8R.jpg"}], 
	[{title: "Beyond the Pale"},
	 {date: "1992"},
	 {image: "https://i.imgur.com/HWA0Zwh.jpg?1"}], 
]
...
influencers = [
	...
	[{name: "Alison Wolf"},
	 {author: true},
	 {image: "https://i.imgur.com/QQdND1R.jpg"}],
	# bad feminist
	[{name: "Roxan Gay"},
	 {author: true},
	 {image: "https://i.imgur.com/BDdPBpj.jpg"}],
	# the feminist porn 
	[{name: "Mireille Miller-Young"},
	 {author: true},
	 {image: "https://i.imgur.com/ZY3KJwz.jpg"}],
	[{name: "Tristan Taormino"},
	 {author: true},
	 {image: "https://i.imgur.com/Hu97b8z.jpg"}],
	[{name: "Celine Parrenas Shimizu"},
	 {author: true},
	 {image: "https://i.imgur.com/q1WDUc2.jpg"}],
	[{name: "Constance Penley"},
	 {author: true},
	 {image: "https://i.imgur.com/PaNrWX1.jpg"}],
	# feminism unfinished
	[{name: "Dorothy Sue Cobble"},
	 {author: true},
	 {image: "https://i.imgur.com/y5RaveW.jpg"}],
	[{name: "Linda Gordon"},
	 {author: true},
	 {image: "https://i.imgur.com/NsPGHIf.jpg"}],
	[{name: "Astrid Henry"},
	 {author: true},
	 {image: "https://i.imgur.com/0bH0ViE.jpg"}],
	# separate and dominate
	[{name: "Christine Delphy"},
	 {author: true},
	 {image: "https://i.imgur.com/nxztJkI.jpg"}],
	# talking back
	[{name: "Bell Hooks"},
	 {author: true},
	 {image: "https://i.imgur.com/mha2Jhm.jpg"}],	
	# hard to get
	[{name: "Leslie C. Bell"},
	 {author: true},
	 {image: "https://i.imgur.com/2xT3UR9.jpg"}],	
	#  lean in 
	[{name: "Sheryl Sandberg"},
	 {author: true},
	 {image: "https://i.imgur.com/LmGgISB.jpg"}],
	# pussy riot
	[{name: "The Feminist Press"},
	 {author: true},
	 {image: "https://i.imgur.com/xzdrkBf.png"}],
	# a class by herself
	[{name: "Nancy Woloch"},
	 {author: true},
	 {image: "https://i.imgur.com/jt20tfa.jpg"}],
	# woman
	[{name: "Natalie Angier"},
	 {author: true},
	 {image: "https://i.imgur.com/aGPIAk7.jpg"}],
	# beyond the pale
	[{name: "Vron Ware"},
	 {author: true},
	 {image: "https://i.imgur.com/rNBnv2b.jpg?1"}],
]
